var appmgrPrivacyApp = angular.module('appmgr-privacy', []);

appmgrPrivacyApp.controller('appmgrPrivacyCtrl', ['$scope',
    function ($scope) {
        $scope.openStatement = function () {
            CmdTarget.openPrivacyStatement();
        };

        $scope.agree = function () {
            PrivacyPolicyWindow.accept();
        };

        $scope.cancel = function () {
            PrivacyPolicyWindow.cancel();
        };
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFNgMzLUmH5LE
// SIG // 6JekdoUx+ogoz0ugoIIUMDCCA+4wggNXoAMCAQICEH6T
...
// SIG // 9w0BCQQxFgQUZNkDTdYkbnKiGuTNArO+QwpuzLUwVAYK
...
// SIG // AQAMP52VW/EgN1Vm3nYBebHQ0mlCrKBnurAlhmt7EsOJ
// SIG // sOtxPvHRDZjR4uATX8MTR0uVnUBBhaSDFJCXOf37xfTk
// SIG // xq8yWTkm929JOlotacTWy10MF6E/9v/b4wR89iWPWLNc
// SIG // KjFwTzv1L5l+Fk9tLyvhWcOkJjDRvzPI7V9qX0EKwAjJ
// SIG // iB23pBf9GCLLR2I1seLQEiT3ReGQhjausI2vHJ66YXjE
// SIG // LZThVXbPXweU4ZnQd/q5D4k5jzABAGI3001x6BJcTIi9
// SIG // QYEsywU0d5ZPY8hYsIHTm9cbGL6PVrBKwgrxbac5ZZPD
// SIG // KEw+b/JLDgGFqX+iewO+ywfSoYB5EZggAuLyoYICCzCC
...
// SIG // MTIwNTAyMjc1OVowIwYJKoZIhvcNAQkEMRYEFGAbJ2r+
// SIG // jaCdtfZlPL0iDkxMqklmMA0GCSqGSIb3DQEBAQUABIIB
// SIG // AAJGGhOa2Ij/ztq4mKtmRojmPfu5T+jHGevZS+KxwBgW
// SIG // EbLTB/rECwc56Cs/q0I/WhrRVWYjtFkI4t9gXliuytuO
// SIG // 5zOoriolm5ZIvErijATPach3xBZ3OtTtmLZZ+Z3b/rXJ
// SIG // bdEX1IJPN55pkRdCLllESO5VaJS/ZkSgokLeUyKjl1S2
// SIG // NFTPq7LcYf1pZWbx61YnnxfPZN5JbfaIPnwUIghC9Bqk
// SIG // +T19PMuWeQdKCzVood7Eg+awrapVDtqBQi0rEkFevrBw
// SIG // BzwdBjv3SAN9H9mtQa6u1Wm4prGOQRuWmWnbLSvew+At
// SIG // Jjr/LXBiECJKPUcM7z8uY4KzPK7ydbwuiR4=
