appmgrMainApp.directive('fallbackSrc', function () {
    return {
        link: function (scope, elem, attrs) {
            elem.bind('error', function () {
                elem.attr('src', attrs.fallbackSrc);
            });
        }
    }
});

appmgrMainApp.directive('multiActionArrow', function ($document) {
    return {
        restrict: 'A',
        link: function (scope, elem, attr, ctrl) {
            elem.bind('click', function (e) {
                if (!angular.element(elem).hasClass('disabled')) {
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPicPTHF6gE5
// SIG // 8Ly1XvUCfFLH/4buoIIUMDCCA+4wggNXoAMCAQICEH6T
...
// SIG // 9w0BCQQxFgQUuicM+tlpdsm0Mw4Er+uV/oDM/PAwVAYK
...
// SIG // AQAtWZB7NRqD/B9PFkNlUHl0k1owI+LG+vQ485MegrRa
// SIG // 5+9HvEg+gUUND01gIse24hcOt4S0TFWNOBWdQu7UHJ2m
// SIG // 4DwDwRTVbDh256MJs0dWm+dQxRr9+PfVg7nisGiuYM+L
// SIG // jWf5sFPXOKSTtR/eZKcWtxZ/v73f6dGWWviMio5wPwCV
// SIG // /vinMZTZ9KjD2ZHilUv2U7ThW5Ue05f30YeIYbwZ547R
// SIG // LE+pQgWPYuuVBIvWiQZ9Z/UjaUr635wnmRHlEPRjqJaX
// SIG // /YfzcknmIn9OXUATYGktpLnXManMuWhjbkEllQtKsvw0
// SIG // GJzQAg/wRx96+nD3Ib9r0GImWWI3z2eKftugoYICCzCC
...
// SIG // MTIwNTAyMjc1MVowIwYJKoZIhvcNAQkEMRYEFEtNBq41
// SIG // MfSbRF8NDTqTn1kAGPx0MA0GCSqGSIb3DQEBAQUABIIB
// SIG // AG3bVZ2S8fMzad9u8NZTS6FVZRUkEDjwm83xYXhZ9+G/
// SIG // EbEQZiJISbqznoPkGB5uZOkrwkW47+GfDejTuDAg/8dr
// SIG // +s9DEDiGWLtqTsQ7pvRNsFVNCJI8/ksoLDntDoISy/6p
// SIG // 2BkOW+xmvTbmd/QHYPa607M0z7wzUAH5RpV6vk7cNrm8
// SIG // DFnq3eahT4dj/zjP9b0NjB1KjyvGDHcv0Y/7a1olevbg
// SIG // zkOE631m0i2Zkuc7cQvLbLHkAs+NI7dtw8s/m65Uo8lx
// SIG // 4tqF0NXguK6nEGiLudSzntq3as9syJ3fXUfFaPyAufkn
// SIG // +ZbumAS2ndlGntU6YRZQZJ6d5094p7Ussus=
