...
Sometimes, you're doing extensive keyword research before writing your blog post. During the research process, you might be leveraging tools such as [Google Keyword Planner](https://ads.google.com/home/tools/keyword-planner/), [ahrefs](https://github.com/schultyy/better-seo/blob/HEAD/ahrefs.com) or [SEMRush](https://www.semrush.com/) to come up with a list of keywords.
