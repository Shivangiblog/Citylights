...
!function () {
  ...
  function g(e, r) {
    ...
    for (var n = 0; n < e.length; ++n) {
      ...
      if (
        'lang' !==
          (i =
            'html' === (i = 'language' === i ? (o.type = 'lang') : i) ? (o.type = 'output') : i) &&
        'output' !== i &&
        'listener' !== i
      )
        return (
      ...
      if ('listener' === i) {
        if (x.helper.isUndefined(o.listeners))
          return (
            (a.valid = !1),
            (a.error =
              s + '. Extensions of type "listener" must have a property called "listeners"'),
            a
          )
        ...
        return (
          (a.valid = !1),
          (a.error =
            s + i + ' extensions must define either a "regex" property or a "filter" method'),
          a
        )
      if (o.listeners) {
        if ('object' != typeof o.listeners)
          return (
            (a.valid = !1),
            (a.error =
              s + '"listeners" property must be an object but ' + typeof o.listeners + ' given'),
            a
          )
  ...
  function o(n, s) {
    ...
    return function (e, r, t) {
      ...
      return (
        ...
        n.encodeEmails
          ? ((a = x.helper.encodeEmailAddress(a + t)), (t = x.helper.encodeEmailAddress(t)))
          : (a += t),
        r + '<a href="' + a + '">' + t + '</a>'
      )
    }
  ...
  x.subParser('autoLinks', function (e, r, t) {
    'use strict'
    return (
      (e = (e = (e = t.converter._dispatch('autoLinks.before', e, r, t)).replace(c, s(r))).replace(
        f,
        o(r, t)
      )),
    ...
    x.subParser('blockQuotes', function (e, r, t) {
      ...
      return (
        ...
        (e = (e += '\n\n').replace(a, function (e) {
          return (
            (e = (e = (e = e.replace(/^[ \t]*>[ \t]?/gm, '')).replace(/¨0/g, '')).replace(
              /^[ \t]+$/gm,
              ''
            )),
    ...
    x.subParser('codeSpans', function (e, n, s) {
      ...
      return (
        (e = (e =
          void 0 === (e = s.converter._dispatch('codeSpans.before', e, n, s)) ? '' : e).replace(
          /(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm,
          function (e, r, t, a) {
            return (
    ...
    x.subParser('images', function (e, r, d) {
      ...
      function l(e, r, t, a, n, s, o, i) {
        var l = d.gUrls,
          c = d.gTitles,
          u = d.gDimensions
        if (((t = t.toLowerCase()), (i = i || ''), -1 < e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m)))
          a = ''
        else if ('' === a || null === a) {
          if (
                ...
                (n = (n =
                  r || -1 < n.search(/\n{2,}/)
                    ...
                    : ((n = (n = x.subParser('lists')(n, d, c)).replace(/\n$/, '')),
                      ...
                      (l ? x.subParser('paragraphs') : x.subParser('spanGamut'))(n, d, c))).replace(
                  '¨A',
                  ''
                )) +
                '</li>\n')
          ...
          ((e = (e = a.converter._dispatch('strikethrough.before', e, t, a)).replace(
            ...
            function (e, r) {
              return (
                (r = r),
                '<del>' +
                  (r = t.simplifiedAutoLink ? x.subParser('simplifiedAutoLinks')(r, t, a) : r) +
                  '</del>'
              )
            }
          )),
        ...
        for (t = 0; t < u.length; ++t) {
          for (var _ = [], g = 0; g < d.length; ++g)
            x.helper.isUndefined(u[t][g]),
              _.push(
                ((i = u[t][g]), '<td' + p[g] + '>' + x.subParser('spanGamut')(i, y, P) + '</td>\n')
              )
          h.push(_)
        }
        for (var m = d, f = h, b = '<table>\n<thead>\n<tr>\n', w = m.length, k = 0; k < w; ++k)
          b += m[k]
        for (b += '</tr>\n</thead>\n<tbody>\n', k = 0; k < f.length; ++k) {
          b += '<tr>\n'
    ...
    x.subParser('makeMarkdown.txt', function (e) {
      ...
      return (
        ...
        (e = (e = (e = (e = (e = (e = (e = (e = (e = x.helper.unescapeHTMLEntities(e)).replace(
          ...
          /^(\s*)([-=]{3,})(\s*)$/,
          '$1\\$2$3'
        )).replace(/^( {0,3}\d+)\./gm, '$1\\.')).replace(/^( {0,3})([+-])/gm, '$1\\$2')).replace(
          /]([\s]*)\(/g,
          '\\]$1\\('
        )).replace(/^ {0,3}\[([\S \t]*?)]:/gm, '\\[$1]:'))
      )
